...
from DominatorBot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
...
@dominator_cmd(pattern="savewelcome(?:\s|$)([\s\S]*)")
...
@dominator_cmd(pattern="cleanwelcome$")
...
@dominator_cmd(pattern="showwelcome$")
...
@dominator_cmd(pattern="welcome_note$")
