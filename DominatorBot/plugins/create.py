...
@dominator_cmd(pattern="create (b|g|c) ([\s\S]*)")
async def _(event):
    type_of_group = event.pattern_match.group(1)
    group_name = event.pattern_match.group(2)
    dominator = await eor(event, "Creating wait sar.....")
    if type_of_group == "b":
        try:
        ...
        await dominator.edit(f"Read `{hl}plinfo create` to know how to use me")


@dominator_cmd(pattern="link ([\s\S]*)")
