...
async def update(event, repo, ups_rem, ac_br):
    ...
    await eor(event, "✅ Successfully updated Ꭰօʍìղąէօɾβօէ!\n\nBot is restarting please wait for a minute.")
...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond(f"🌚 Do `{hl}update build` to update your **Ꭰօʍìղąէօɾβօէ** !!")
...
async def upstream(event):
    ...
    off_repo = "https://github.com/The-DominatorBot/DominatorBot"
    os.chdir("/app")
...
CmdHelp("update").add_command(
  ...
  "update now", None, "Soft-Update Your Ꭰօʍìղąէօɾβօէ. Basically if you restart dyno it will go back to previous deploy."
).add_command(
  "update build", None, "Hard-Update Your Ꭰօʍìղąէօɾβօէ. This won't take you back to your previous deploy. This will be triggered even if there is no changelog."
).add_info(
  "Ꭰօʍìղąէօɾβօէ Updater."
).add_warning(
  "✅ Harmless Module."
).add()
