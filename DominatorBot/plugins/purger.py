...
@dominator_cmd(pattern="purgeme(?:\s|$)([\s\S]*)")
@errors_handler
...
CmdHelp("purger").add_command(
  ...
  "sd", "<time> | <text>", "Sends a self destruct text. Fill time in secs", "sd 10 | dominatoro"
).add_command(
