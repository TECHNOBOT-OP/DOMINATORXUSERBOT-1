...
@Dominator_cmd(pattern="sin(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="cos(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="tan(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="cosec(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="sec(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="cot(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="square(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="cube(?:\s|$)([\s\S]*)")
