...
USER_BOT_WARN_ZERO = "𝔼𝕟𝕠𝕦𝕘𝕙 𝕆𝕗 𝕐𝕠𝕦𝕣 𝔽𝕝𝕠𝕠𝕕𝕚𝕟𝕘 𝕀𝕟 𝕄𝕪 𝕄𝕒𝕤𝕥𝕖𝕣'𝕤 𝔻𝕆𝕄𝕀ℕ𝔸𝕋𝕆ℝℙ𝕄!! \n\n**🚫 𝔹𝕝𝕠𝕔𝕜𝕖𝕕 𝕒𝕟𝕕 ℝ𝕖𝕡𝕠𝕣𝕥𝕖𝕕.**"
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            await tbot.send_message(LOG_GP, f"#DOMINATOR_REQUEST \n\n⚜️ 𝕐𝕠𝕦 𝕘𝕠𝕥 𝕒 𝔻𝕆𝕄𝕀ℕ𝔸𝕋𝕆ℝ 𝕣𝕖𝕢𝕦𝕖𝕤𝕥 𝕗𝕣𝕠𝕞 [{first_name}](tg://user?id={event.query.user_id}) !")
