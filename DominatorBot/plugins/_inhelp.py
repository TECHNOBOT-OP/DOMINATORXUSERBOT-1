...
USER_BOT_WARN_ZERO = "𝔼𝕟𝕠𝕦𝕘𝕙 𝕆𝕗 𝕐𝕠𝕦𝕣 𝔽𝕝𝕠𝕠𝕕𝕚𝕟𝕘 𝕀𝕟 𝕄𝕪 𝕄𝕒𝕤𝕥𝕖𝕣'𝕤 𝔻𝕆𝕄𝕀ℕ𝔸𝕋𝕆ℝ ℙ𝕄!! \n\n**🚫 𝔹𝕝𝕠𝕔𝕜𝕖𝕕 𝕒𝕟𝕕 ℝ𝕖𝕡𝕠𝕣𝕥𝕖𝕕.**"
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "DominatorBot_help":
            ...
            dominator_FIRST = "**🔥 𝔻𝕠𝕞𝕚𝕟𝕒𝕥𝕠𝕣𝔹𝕠𝕥 ℙ𝕣𝕚𝕧𝕒𝕥𝕖 ℂ𝕪𝕓𝕖𝕣 𝕊𝕖𝕔𝕦𝕣𝕚𝕥𝕪 ℙ𝕣𝕠𝕥𝕠𝕔𝕠𝕝 🔥**\n\ђєɭɭ๏!! 𝕎𝕖𝕝𝕔𝕠𝕞𝕖 𝕋𝕠 {}'𝕤 𝔻𝕠𝕞𝕚𝕟𝕒𝕥𝕠𝕣𝔹𝕠𝕥 ℙ𝕄. 𝕋𝕙𝕚𝕤 𝕚𝕤 𝕒𝕟 𝕒𝕦𝕥𝕠𝕞𝕒𝕥𝕖𝕕 𝕞𝕖𝕤𝕤𝕒𝕘𝕖.\n\n{}".format(dominator_mention, CSTM_PMP)
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            await tbot.send_message(LOG_GP, f"#DOMINATOR_REQUEST \n\n⚜️ 𝕐𝕠𝕦 𝕘𝕠𝕥 𝕒 𝔻𝕠𝕞𝕚𝕟𝕒𝕥𝕠𝕣𝔹𝕠𝕥 𝕣𝕖𝕢𝕦𝕖𝕤𝕥 𝕗𝕣𝕠𝕞 [{first_name}](tg://user?id={event.query.user_id}) !")
