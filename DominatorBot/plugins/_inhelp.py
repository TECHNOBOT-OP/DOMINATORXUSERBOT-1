...
USER_BOT_WARN_ZERO = "𝔼𝕟𝕠𝕦𝕘𝕙 𝕆𝕗 𝕐𝕠𝕦𝕣 𝔽𝕝𝕠𝕠𝕕𝕚𝕟𝕘 𝕀𝕟 𝕄𝕪 𝕄𝕒𝕤𝕥𝕖𝕣'𝕤 Ｄօᵐıη𝒶𝓽𝔬ｒ乃ᵒ𝓽ℙ𝕄!! \n\n**🚫 𝔹𝕝𝕠𝕔𝕜𝕖𝕕 𝕒𝕟𝕕 ℝ𝕖𝕡𝕠𝕣𝕥𝕖𝕕.**"

alive_txt = """{}\n
<b><i>🏅 𝙱𝚘𝚝 𝚂𝚝𝚊𝚝𝚞𝚜 🏅</b></i>
<b>Telethon ≈</b>  <i>{}</i>
<b>Ｄօᵐıη𝒶𝓽𝔬ｒ乃ᵒ𝓽 ≈</b>  <i>{}</i>
<b>Uptime ≈</b>  <i>{}</i>
<b>Abuse ≈</b>  <i>{}</i>
<b>Sudo ≈</b>  <i>{}</i>
"""
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "DominatorBot_help":
            ...
            if a:
                ...
                help_msg = f"💥💥 **{dominator_mention}**\n\n💥💥∂σмιηαтσя-φӀմցìղʂ : `{len(CMD_HELP)}` \n💥💥∂σмιηαтσя-↻ʍժʂ: `{len(apn)}`\n💥💥∂σмιηαтσя-φąցҽʂ: 1/{veriler[0]}"
            ...
            alv_msg = gvarstat("ALIVE_MSG") or "»»» <b>∂σмιηαтσявσт įʂ ටղƑìɾҽ</b> «««"
            ...
            CSTM_PMP = gvarstat("CUSTOM_PMPERMIT") or "**𝕐𝕠𝕦 ℍ𝕒𝕧𝕖 𝕋𝕣𝕖𝕤𝕡𝕒𝕤𝕤𝕖𝕕 𝕋𝕠 𝕄𝕪 𝕄𝕒𝕤𝕥𝕖𝕣'𝕤 ∂σмιηαтσявσт ℙ𝕄.!\n𝕋𝕙𝕚𝕤 𝕀𝕤 𝕀𝕝𝕝𝕖𝕘𝕒𝕝 𝔸𝕟𝕕 ℝ𝕖𝕘𝕒𝕣𝕕𝕖𝕕 𝔸𝕤 ℂ𝕣𝕚𝕞𝕖.**"
            dominator_FIRST = "**🔥 ∂σмιηαтσявσтէ ℙ𝕣𝕚𝕧𝕒𝕥𝕖 𝕌𝕝𝕥𝕣𝕠𝕟 ℂ𝕪𝕓𝕖𝕣 𝕊𝕖𝕔𝕦𝕣𝕚𝕥𝕪 ℙ𝕣𝕠𝕥𝕠𝕔𝕠𝕝 🔥**\n\ђєɭɭ๏!! 𝕎𝕖𝕝𝕔𝕠𝕞𝕖 𝕋𝕠 {}'𝕤 ∂σмιηαтσявσт ℙ𝕄. 𝕋𝕙𝕚𝕤 𝕚𝕤 𝕒𝕟 𝕒𝕦𝕥𝕠𝕞𝕒𝕥𝕖𝕕 𝕞𝕖𝕤𝕤𝕒𝕘𝕖.\n\n{}".format(dominator_mention, CSTM_PMP)
            ...
            if PIC and PIC.endswith((".jpg", ".png")):
                ...
                result = builder.document(
                    ...
                    buttons=[
                        [custom.Button.inline("📝 ∂σмιηαтσя ℝ𝕖𝕢𝕦𝕖𝕤𝕥 𝔸𝕡𝕡𝕣𝕠𝕧𝕒𝕝", data="req")],
                ...
                result = builder.article(
                    text=dominator_FIRST,
                    title="∂σмιηαтσявσт𝕥 ℙ𝕄 ℙ𝕖𝕣𝕞𝕚𝕥.",
                    buttons=[
                        [custom.Button.inline("📝 ∂σмιηαтσявσт ℝ𝕖𝕢𝕦𝕖𝕤𝕥 𝔸𝕡𝕡𝕣𝕠𝕧𝕒𝕝", data="req")],
                        [custom.Button.inline("🚫 𝔹𝕝𝕠𝕔𝕜", data="heheboi")],
                        [custom.Button.inline("❓ ℂ𝕦𝕣𝕚𝕠𝕦𝕤.", data="pmclick")],
                    ],
                    link_preview=False,
            ...
            result = builder.article(
                title="Repository",
                text=f"**⚡ Ꝉҽցҽղժąɾվ ȺƑ ∂σмιηαтσявσтէ⚡**",
                buttons=[
                    [Button.url("💥∂σмιηαтσявσт ɾҽքօʂ 💥", "https://github.com/LEGENDXTHANOS/DominatorbOT")],
                    [Button.url("💥∂σмιηαтσявσт ហҽէաօɾҟ💥", "https://t.me/DominatorBot_OP")],
                ],
            )
            ...
            result = builder.article(
                "@DominatorBot_XD",
                text="""**ℍ𝕖𝕪! 𝕋𝕙𝕚𝕤 𝕀𝕤 [∂σмιηαтσявσт](https://t.me/DominatorBot_XD) \n𝕐𝕠𝕦 𝕔𝕒𝕟 𝕜𝕟𝕠𝕨 𝕞𝕠𝕣𝕖 𝕒𝕓𝕠𝕦𝕥 𝕞𝕖 𝕗𝕣𝕠𝕞 𝕥𝕙𝕖 𝕝𝕚𝕟𝕜𝕤 𝕘𝕚𝕧𝕖𝕟 𝕓𝕖𝕝𝕠𝕨 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 ∂σмιηαтσявσт ↻հąղղҽӀ 🔥", "https://t.me/DominatorBot_OP"),
                        custom.Button.url("⚡ ∂σмιηαтσявσт Ɠɾօմք ⚡", "https://t.me/DominatorBot_XD"),
                    ],
                    [
                        custom.Button.url("✨ ∂σмιηαтσявσт ɾҽքօʂ ✨", "https://github.com/LEGENDXTHANOS/DominatorbOT"),
                        custom.Button.url("🔰 ∂σмιηαтσявσт ɾҽքӀʂ 🔰", "https://replit.com/@LEGEND-LX/PYTHONBOT-4"),
                    ],
                ],
                link_preview=False,
            )
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            reply_pop_up_alert = "🔰 𝕋𝕙𝕚𝕤 𝕚𝕤 ∂σмιηαтσявσт ℙ𝕄 𝕊𝕖𝕔𝕦𝕣𝕚𝕥𝕪 𝕥𝕠 𝕜𝕖𝕖𝕡 𝕒𝕨𝕒𝕪 𝕦𝕟𝕨𝕒𝕟𝕥𝕖𝕕 𝕣𝕖𝕥𝕒𝕣𝕕𝕤 𝕗𝕣𝕠𝕞 𝕤𝕡𝕒𝕞𝕞𝕚𝕟𝕘 ℙ𝕄 !!"
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            await tbot.send_message(LOG_GP, f"#∂σмιηαтσявσт_REQUEST \n\n⚜️ 𝕐𝕠𝕦 𝕘𝕠𝕥 𝕒 ∂σмιηαтσявσт 𝕣𝕖𝕢𝕦𝕖𝕤𝕥 𝕗𝕣𝕠𝕞 [{first_name}](tg://user?id={event.query.user_id}) !")
        ...
        if event.query.user_id in auth:
            ...
            for x in CMD_LIST.values():
                for y in x:
                    apn.append(y)
            await event.edit(
                         f"💥💥 **{dominator_mention}**\n\n💥💥∂σмιηαтσя-φӀմցìղʂ𝖗 : `{len(CMD_HELP)}` \n💥💥∂σмιηαтσя-↻ʍժ : `{len(apn)}`\n💥💥∂σмιηαтσя-φąցҽʂ: 1/{veriler[0]}",
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        if event.query.user_id in auth:
            ...
            await event.edit(f"**💥💥∂σмιηαтσявσт 𝕄𝕖𝕟𝕦 ℙ𝕣𝕠𝕧𝕚𝕕𝕖𝕣 𝕀𝕤 ℕ𝕠𝕨 ℂ𝕝𝕠𝕤𝕖𝕕💥💥**\n\n**∂σмιηαтσявσт 𝕆𝕗:**  {dominator_mention}\n\n        [©️∂σмιηαтσявσт™️]({chnl_link})", buttons=veriler, link_preview=False)   
                                #f"╔═══💫✨💫═══\n"
