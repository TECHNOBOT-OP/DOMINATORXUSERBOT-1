...
@Dominator_cmd(pattern="tweet(?:\s|$)([\s\S]*)")
async def nope(kraken):
    dominator = kraken.text[7:]
    ...
    if not dominator:
        if kraken.is_reply:
            ...
            return
    tweeter = await event.client.inline_query("TwitterStatusBot", f"{(deEmojify(dominator))}")
...
@Dominator_cmd(pattern="trump(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="modi(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[6:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="mia(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[5:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="dani(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[6:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="pappu(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[7:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="sunny(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[7:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="johhny(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[8:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="gandhi(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[8:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="cmm(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[5:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@Dominator_cmd(pattern="kanna(?:\s|$)([\s\S]*)")
async def nekobot(event):
    text = event.text[7:]
    reply_to_id = event.message
    if event.reply_to_msg_id:
