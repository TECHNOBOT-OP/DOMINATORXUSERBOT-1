...
async def viello(event):
    ...
    DOMINATOR_PIC = "https://te.legra.ph/file/b86eff074051b0b2d4513.jpg"
    ...
    if DOMINATOR_PIC:
        ...
        on = await event.client.send_file(
            event.chat_id, file=DOMINATOR_PIC, caption=HELLO, reply_to=reply_to_id
        )
        ...
        await asyncio.sleep(5)
        ok5 = await event.client.edit_message(event.chat_id, ok4, file=DOMINATOR_PIC)
        await event.delete()
...
async def blilbye(event):
    ...
    if BYE_PIC := "https://te.legra.ph/file/aa16cad62645045062c0f.jpg":
        dominatorevent = await eor(event, "**❛ Bye ❜!**")
        lol = "Bye Friends"
