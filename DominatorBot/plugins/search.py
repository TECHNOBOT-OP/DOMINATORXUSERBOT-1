...
@dominator_cmd(pattern="ytube(?:\s|$)([\s\S]*)")
async def _(event):
...
@dominator_cmd(pattern="ddg(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
    sample_url = (
...
@dominator_cmd(pattern="altn(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@dominator_cmd(pattern="var(?:\s|$)([\s\S]*)")
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@dominator_cmd(pattern="lmlog(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@dominator_cmd(pattern="hacc(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@dominator_cmd(pattern="lmkp(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@dominator_cmd(pattern="gem(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
...
@dominator_cmd(pattern="rchiv(?:\s|$)([\s\S]*)")
async def _(event):
    input_str = event.pattern_match.group(1)
