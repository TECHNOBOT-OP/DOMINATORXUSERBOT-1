...
@dominator_cmd(pattern="sing$")
async def _(e):
    txt = random.choice(SONGS)
    await eor(e, txt)

@dominator_cmd(pattern="hps$")
async def _(e):
    txt = random.choice(HARRY)
    await eor(e, txt)

@dominator_cmd(pattern="gott$")
async def _(e):
    txt = random.choice(GOTT)
    await eor(e, txt)

@dominator_cmd(pattern="gotm$")
async def _(e):
    txt = random.choice(GOTM)
    await eor(e, txt, link_preview=True)

@dominator_cmd(pattern="bello$")
async def _(e):
    txt = random.choice(BELLO)
    await eor(e, txt)

@dominator_cmd(pattern="tip$")
async def _(e):
    txt = random.choice(TIPS)
    await eor(e, txt)

@dominator_cmd(pattern="qt$")
async def _(e):
    txt = random.choice(QT)
    await eor(e, txt)

@dominator_cmd(pattern="logic$")
async def _(e):
    txt = random.choice(LOGIC)
    await eor(e, txt)

@dominator_cmd(pattern="snow$")
async def _(e):
    txt = random.choice(SNOW)
    await eor(e, txt)

@dominator_cmd(pattern="shayri$")
async def _(e):
    _, _, dominator_mention = await client_id(e)
    txt = random.choice(SHAYRI)
    await eor(e, txt.format(dominator_mention))

@dominator_cmd(pattern="hflirt$")
async def _(e):
    _, _, dominator_mention = await client_id(e)
    txt = random.choice(HFLIRT)
    await eor(e, txt.format(dominator_mention))

@dominator_cmd(pattern="eflirt$")
async def _(e):
    _, _, dominator_mention = await client_id(e)
    txt = random.choice(EFLIRT)
    await eor(e, txt.format(dominator_mention))

@dominator_cmd(pattern="attitude$")
async def _(e):
    _, _, dominator_mention = await client_id(e)
    txt = random.choice(ATTITUDE)
    await eor(e, txt.format(dominator_mention))

@dominator_cmd(pattern="gbye$")
async def _(e):
    _, _, dominator_mention = await client_id(e)
