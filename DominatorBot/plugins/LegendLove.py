...
@dominator_cmd(pattern="i love u")
async def lub(ult):
  l = random.choice(love)
  return await eor(ult, l)


CmdHelp("i love u").add_command(
  "i love u", None, "USAGE : GIVES I LOVE YOU TEXTS SOME TEXTS MAY NOT BE VISIBLE IN PHONES CAUSE OF SCREEN WIDENESS"
).add_warning(
  "✅ Harmless Module"
).add()
