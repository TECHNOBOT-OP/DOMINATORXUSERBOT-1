...
@Dominator_cmd(pattern="device(?:\s|$)([\s\S]*)")
...
@Dominator_cmd(pattern="codename(?: |)([\S]*)(?: |)([\s\S]*)")
...
@Dominator_cmd(pattern="specs(?: |)([\S]*)(?: |)([\s\S]*)")
...
@Dominator_cmd(pattern="twrp(?:\s|$)([\s\S]*)")
