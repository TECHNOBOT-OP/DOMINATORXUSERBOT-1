...
class Config(object):
    ...
    DOMINATORBOT_SESSION = os.environ.get("DOMINATORBOT_SESSION", None)
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", "./DominatorBot/resources/pics/DominatorBot_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/dominator454/DOMINATORXBOT")
